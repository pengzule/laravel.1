...
@section('content')
  ...
  <div class="pzl_addbutton">
      <ul class="nav navbar-nav">
          <li><button type="submit"  onclick="_toCart()" class="btn btn-lg btn-success col-lg-12">立即购买</button></li>
      </ul>
  </div>
  <div class="pzl_nowbutton">
      <ul class="nav navbar-nav">
      	
         <a href="{{ URL('service/cart/add/'.$product->id) }}"><button type="submit" class="btn btn-lg btn-success col-lg-12" onclick="_addCart()" style="display: inline;">加入购物车</button></a>
      </ul>
  </div>
  <hr>
